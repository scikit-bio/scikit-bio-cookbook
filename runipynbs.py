...
#
# This script was copied from "An Introduction To Applied Bioinformatics"
# (https://github.com/gregcaporaso/An-Introduction-To-Applied-Bioinformatics).
#
# The exact file that was copied:
# https://github.com/gregcaporaso/An-Introduction-To-Applied-Bioinformatics/
#     blob/master/runipynbs.py
#
# See licenses/An-Introduction-To-Applied-Bioinformatics.txt for the original
# license.
# -----------------------------------------------------------------------------
